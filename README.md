...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/MBxpm6ID2n)
...
```sh
npx nx serve daily-words
```

To create a production bundle:

```sh
npx nx build daily-words
```

To see all available targets to run for a project, run:

```sh
npx nx show project daily-words
```
